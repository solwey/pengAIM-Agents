...
def upgrade() -> None:
    ...
    op.create_index("idx_thread_team_user", "thread", ["team_id", "user_id"], unique=False)
...
def downgrade() -> None:
    ...
    op.add_column("assistant", sa.Column("user_id", sa.TEXT(), autoincrement=False, nullable=True))
