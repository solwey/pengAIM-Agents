...
class AssistantCreate(BaseModel):
    ...
    type: str | None = Field(None, description="Assistant type for filtering (e.g., account, library)")
...
class Assistant(BaseModel):
    ...
    team_id: str = Field(..., description="Identifier of the user who owns this assistant.")
    ...
    enabled: bool = Field(default=True, description="Whether the assistant is enabled and can be used")
    type: str | None = Field(default=None, description="Assistant type for filtering (e.g., account, library)")
...
class AssistantSearchRequest(BaseModel):
    ...
    metadata: dict[str, Any] | None = Field({}, description="Metadata to use for searching and filtering assistants.")
    type: str | None = Field(None, description="Filter by assistant type (e.g., account, library)")
